...
อัปเดตล่าสุด: 6 ส.ค. 2026 — **ยืนยันใบหน้าตอนเช็คชื่อ (v33)**: สแกนหน้าสด **1:1** แทนการเก็บรูปเซลฟี่ — เบราว์เซอร์คำนวณเวกเตอร์ 128 มิติ ส่งขึ้น server **แค่ตัวเลข ไม่ส่งรูป**. ไม่ผ่าน 3 ครั้ง = **เช็คชื่อได้แต่ติดธง ⚠️** ให้หัวหน้าเห็น (ไม่บล็อกใครเด็ดขาด). ลงทะเบียนจากรูปเช็คชื่อเดิม 460 ใบผ่าน overlay แอดมิน. **ส่งขึ้น live แบบสวิตช์ปิด** (`face_verify_enabled=0`) — พี่วินต้องลงทะเบียนใบหน้าบน prod ก่อนเปิด. **Technical → CLAUDE.md "ยืนยันใบหน้าตอนเช็คชื่อ"**.
