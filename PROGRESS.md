...
อัปเดตล่าสุด: 6 ก.ย. 2026 — **v38 แก้เคสมือถือไม่เด้ง deploy แล้ว** (commit `497c237` — live ยืนยัน `?v=38` + sw.js `firecheck-v38`, `FACE_CACHE` ไม่ถูกแตะ) · **พี่วินยังไม่ได้เปิดสวิตช์ `push_enabled`**
