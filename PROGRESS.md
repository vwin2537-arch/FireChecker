...
## ทดสอบแล้ว — เฟส 2 ระบบอนุมัติลา (4 ก.ค. 2026, local: PHP 8.5 + MySQL 9.6 — ยังไม่ deploy)

- **โค้ดครบ ยังไม่ deploy** — รอพี่วินเทสในเครื่อง/เว็บก่อนค่อย `railway up` + bump cache v13 ไว้แล้ว
