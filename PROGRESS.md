...
- **ยังไม่ได้ทดสอบ 2 อย่าง (ต้องให้พี่วินทำ):** ① เปิดสวิตช์แล้วให้ จนท. 1 คนลองสแกนหน้าจริงบนมือถือ ② iOS Safari/PWA (localhost ไม่ใช่ secure context ทดสอบจากเครื่อง dev ไม่ได้) — ถ้ากล้องสดเปิดไม่ได้ ระบบถอยไปถ่ายรูปนิ่งเอง ไม่ล็อกคน
